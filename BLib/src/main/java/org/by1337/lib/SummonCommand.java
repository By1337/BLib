...
public class SummonCommand {
    public static void execute(@NotNull String entityType, @NotNull BLocation location, @Nullable String nbt) {
        switch (Version.VERSION) {
            ...
            case V1_18 -> new SummonCommandV1_18().spawn(entityType, location, nbt);
            case V1_18_1 -> new SummonCommandV1_18_1().spawn(entityType, location, nbt);
            case V1_18_2 -> new SummonCommandV1_18_2().spawn(entityType, location, nbt);
            case V1_19 -> new SummonCommandV1_19().spawn(entityType, location, nbt);
            case V1_19_1 -> new SummonCommandV1_19_1().spawn(entityType, location, nbt);
            case V1_19_2 -> new SummonCommandV1_19_2().spawn(entityType, location, nbt);
            case V1_19_3 -> new SummonCommandV1_19_3().spawn(entityType, location, nbt);
