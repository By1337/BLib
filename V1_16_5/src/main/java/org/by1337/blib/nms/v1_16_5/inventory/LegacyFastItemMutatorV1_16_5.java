...
@NMSAccessor(forClazz = LegacyFastItemMutator.class, forVersions = Version.V1_16_5)
public class LegacyFastItemMutatorV1_16_5 implements LegacyFastItemMutator {
    private static final ParseCompoundTag PDC_UTIL = new ParseCompoundTagV165();
    ...
    public void setNBT(@NotNull Object nmsItem, @NotNull String key, @Nullable NBT nbt) {
        ...
        if (nbt == null) {
            ...
            tag.set(key, (Tag) PDC_UTIL.toNMS(nbt));
        }
    }
