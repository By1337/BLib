package org.by1337.blib.nms.v1_20_1.command;
...
@NMSAccessor(forClazz = SummonCommand.class, forVersions = Version.V1_20_1)
public class SummonCommandV1_20_1 implements SummonCommand {
    @Override
        ...
        try {
            ...
            if (entity == null) {
                ...
                if (entity instanceof Mob) {
                    ((Mob) entity).finalizeSpawn(world, world.getCurrentDifficultyAt(entity.blockPosition()), MobSpawnType.COMMAND, null, null);
                }
